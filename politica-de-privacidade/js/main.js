...
document.addEventListener('DOMContentLoaded', function () {
    ...
    closeToggle.addEventListener('click', function () {
      offcanvasMenu.style.animation = "saida_sidebar normal 0.8s";

      setTimeout(function() {
        offcanvasMenu.style.display = "none";
        overlay_offcanvas.style.display = "none"

      }, 800); // Definindo um atraso de 1 segundo para esconder a offcanvas menu após a animação de saída
    });
  });
  ...
  function scrollSlider() {
    ...
    let scrollAmount = 0;
    const cardWidth = cards[0].offsetWidth + 25; // Largura do card + margem direita
    ...
    }, 50000); // Altere o valor para ajustar a velocidade da rolagem
  }
